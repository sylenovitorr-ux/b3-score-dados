...
export default function SwingPage({ assets, anomalies, onBack, onOpen }) {
  ...
  return <div className="swing-page">
    <div className="daily-radar-top"><button className="back-btn" onClick={onBack}>← Visão geral</button><span>SWING 3–6M • hipótese pendente de validação histórica</span></div>
    <section className="swing-hero"><div><span>SELEÇÃO ≠ TIMING</span><h1>Estude o ativo.<br /><em>Depois avalie a entrada.</em></h1><p>Score indica o que estudar. Timing ajuda a avaliar quando entrar. Não é ordem, previsão ou garantia de retorno.</p></div><aside><b>60–126</b><small>pregões esperados</small><p>Pesos iniciais configuráveis e pendentes de backtest.</p></aside></section>
