...
export function routeHash(page, ticker = null) {
  const paths = { home: "", radar: "radar", opportunities: "oportunidades", swing: "swing", analyze: "analisar", asset: "ativo", compare: "comparador", quant: "quant", simulator: "simulador", options: "opcoes", portfolio: "carteira", methodology: "metodologia", integrity: "alertas", advanced: "ferramentas-avancadas" };
